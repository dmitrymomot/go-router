...
// A filesystem whose files cannot seek cannot be served: ServeContent needs to
// seek to size the body. The failure must not go out carrying caching headers.
func TestAFileSystemThatCannotSeekAnswers500(t *testing.T) {
